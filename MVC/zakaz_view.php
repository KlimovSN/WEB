<div class="warning"> Покупка кредитов: </div>
  ...
  <form method="post" action="controller_zakaz.php">
  ...
  <textarea name="comment" class="message" oninput="CheckDescription(this)"></textarea>
		...
		function CheckDescription(input) 
			{
				...
				var myArray = str.match(re);
					...
					if (input.value.length < 3 || myArray != null) 
					{
